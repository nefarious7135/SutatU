...
52. Set Test Variable 
    #ถ้ากรณี Set Variable จะใช้ได้แค่ในtestcaseนั้นๆ แต่ถ้าใช้ Set Test Variable จะใช้ได้ทั้งหมดที่อยุ่ในไฟล์นั้นๆ
    #Ex.Set Test Variable
    ${Num}    Set Variable    10
    Set Test Variable    ${Num}    ${Number}   #${Number} จะสามารถเอาไปใช้ได้ทั้งหมด
