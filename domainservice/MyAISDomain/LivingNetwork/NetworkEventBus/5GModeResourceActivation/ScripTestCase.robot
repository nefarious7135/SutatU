...
test
    ...
    # ProduceKafka    ${CmdDeleteMassage_qa.5GModeActivated}    ${CmdProduce_qa.5GModeActivated}    ${DataProduce_TST_F10_1_1_000}
    ConnectSecureCRTLog1    ${HostURL_10.137.45.30}
    SetLogNull_NSB    ${NameCmdFileLog_5GModeResourceActivation}    ${PathLogNSB}
...
Query
    ${Json}    QueryDataReturnJson    ${DataBaseNameNEB_QA}    ${CollactionNamemyNetworkUserLocation}    ${msisdn}
...
TST_F10_1_1_000
    ...
    ConnectSecureCRTkafaka    ${HostURL_10.138.42.190}
    ProduceKafka5GMode    ${CmdDeleteMassage_qa.5GModeActivated}    ${CmdProduce_qa.5GModeActivated}    ${DataProduce_TST_F10_1_1_000}
    Sleep    5
    #Keep Log
    ConnectSecureCRTLog1    ${HostURL_10.137.45.30}
...
TST_F10_1_1_001
    ...
    #produce kafka 
    ConnectSecureCRTkafaka    ${HostURL_10.138.42.190}
    ProduceKafka5GMode    ${CmdDeleteMassage_qa.5GModeActivated}    ${CmdProduce_qa.5GModeActivated}    ${DataProduce_TST_F10_1_1_001}
    Sleep    5
    #Keep Log
    ConnectSecureCRTLog1    ${HostURL_10.137.45.30}
