...
TST_F13_1_1_004
    ...
    ${ID}    QueryDataReturnID    ${DataBaseNameNSB}    ${CollactionNameLivingNetworkMSISDN}    ${msisdn}
    DelectDataFromID    ${DataBaseNameNSB}    ${CollactionNameLivingNetworkMSISDN}    ${ID}
...
TST_F13_1_1_010
    ...
    #check db
    ${currentDate}    CurrentDate
    VerifyMongoDB    ${Jsondata}    {"msisdn":"66812340012","package":{"currentPackage":"O2103P210305313","productSequenceId":"0002480109997","freeUnitExpireTime":"20230331235959+0700"},"5GMode":{"changeModePerday":{"count":1,"currentDate":"${currentDate}"},"currentMode":{"modeName":"boost_mode","expireDate":"20230419:230545"},"lastDefaultMode":"max_mode"}}
    ${ID}    QueryDataReturnID    ${DataBaseNameNSB}    ${CollactionNameLivingNetworkMSISDN}    ${msisdn}
    DelectDataFromID    ${DataBaseNameNSB}    ${CollactionNameLivingNetworkMSISDN}    ${ID}
...
TST_F13_1_1_061
    ...
    #check db
    ${currentDate}    CurrentDate
    VerifyMongoDB    ${Jsondata}    {"msisdn":"66812344001","package":{"currentPackage":"O2103P210305313","productSequenceId":"0002480109997","freeUnitExpireTime":"20240401000000+0800"},"5GMode":{"changeModePerday":{"count":1,"currentDate":"${currentDate}"},"currentMode":{"modeName":"game_mode","expireDate":"20230420:142610"},"lastDefaultMode":"max_mode"}}
    ${ID}    QueryDataReturnID    ${DataBaseNameNSB}    ${CollactionNameLivingNetworkMSISDN}    ${msisdn}
    DelectDataFromID    ${DataBaseNameNSB}    ${CollactionNameLivingNetworkMSISDN}    ${ID}
...
TST_F13_1_1_062
    ...
    #check db
    ${currentDate}    CurrentDate
    VerifyMongoDB    ${Jsondata}    {"msisdn":"66812344002","package":{"currentPackage":"O2103P210305313","productSequenceId":"0002480109997","freeUnitExpireTime":"20240401000000+0800"},"5GMode":{"changeModePerday":{"count":1,"currentDate":"${currentDate}"},"currentMode":{"modeName":"game_mode","expireDate":"20230420:143234"},"lastDefaultMode":"max_mode"}}
    ${ID}    QueryDataReturnID    ${DataBaseNameNSB}    ${CollactionNameLivingNetworkMSISDN}    ${msisdn}
    DelectDataFromID    ${DataBaseNameNSB}    ${CollactionNameLivingNetworkMSISDN}    ${ID}
...
TST_F13_1_1_066
    ...
    #check db
    ${currentDate}    CurrentDate
    VerifyMongoDB    ${Jsondata}    {"msisdn":"66812344006","package":{"currentPackage":"O2103P210305313","productSequenceId":"0002480109997","freeUnitExpireTime":"20240401000000+0800"},"5GMode":{"changeModePerday":{"count":1,"currentDate":"${currentDate}"},"currentMode":{"modeName":"game_mode","expireDate":"20230420:155543"},"lastDefaultMode":"max_mode"}}
    ${ID}    QueryDataReturnID    ${DataBaseNameNSB}    ${CollactionNameLivingNetworkMSISDN}    ${msisdn}
    DelectDataFromID    ${DataBaseNameNSB}    ${CollactionNameLivingNetworkMSISDN}    ${ID}
...
TST_F13_1_1_067
    ...
    #check db
    ${currentDate}    CurrentDate
    VerifyMongoDB    ${Jsondata}    {"msisdn":"66812344007","package":{"currentPackage":"O2103P210305313","productSequenceId":"0002480109997","freeUnitExpireTime":"20240401000000+0800"},"5GMode":{"changeModePerday":{"count":1,"currentDate":"${currentDate}"},"currentMode":{"modeName":"game_mode","expireDate":"20230420:160027"},"lastDefaultMode":"max_mode"}}
    ${ID}    QueryDataReturnID    ${DataBaseNameNSB}    ${CollactionNameLivingNetworkMSISDN}    ${msisdn}
    DelectDataFromID    ${DataBaseNameNSB}    ${CollactionNameLivingNetworkMSISDN}    ${ID}
...
TST_F13_1_1_068
    ...
    #check db
    ${currentDate}    CurrentDate
    VerifyMongoDB    ${Jsondata}    {"msisdn":"66812344008","package":{"currentPackage":"O2103P210305313","productSequenceId":"0002480109997","freeUnitExpireTime":"20240401000000+0800"},"5GMode":{"changeModePerday":{"count":1,"currentDate":"${currentDate}"},"currentMode":{"modeName":"game_mode","expireDate":"20230420:161029"},"lastDefaultMode":"max_mode"}}
    ${ID}    QueryDataReturnID    ${DataBaseNameNSB}    ${CollactionNameLivingNetworkMSISDN}    ${msisdn}
    DelectDataFromID    ${DataBaseNameNSB}    ${CollactionNameLivingNetworkMSISDN}    ${ID}
...
TST_F13_1_1_069
    ...
    #check db
    ${currentDate}    CurrentDate
    VerifyMongoDB    ${Jsondata}    {"msisdn":"66812344009","package":{"currentPackage":"O2103P210305313","productSequenceId":"0002480109997","freeUnitExpireTime":"20240401000000+0800"},"5GMode":{"changeModePerday":{"count":1,"currentDate":"${currentDate}"},"currentMode":{"modeName":"game_mode","expireDate":"20230420:162050"},"lastDefaultMode":"max_mode"}}
    ${ID}    QueryDataReturnID    ${DataBaseNameNSB}    ${CollactionNameLivingNetworkMSISDN}    ${msisdn}
    DelectDataFromID    ${DataBaseNameNSB}    ${CollactionNameLivingNetworkMSISDN}    ${ID}
...
TST_F13_1_1_075
    ...
    #check db
    ${currentDate}    CurrentDate
    VerifyMongoDB    ${Jsondata}    {"msisdn":"66812344011","package":{"currentPackage":"O2103P210305313","productSequenceId":"0002480109997","freeUnitExpireTime":"20240401000000+0800"},"5GMode":{"changeModePerday":{"count":1,"currentDate":"${currentDate}"},"currentMode":{"modeName":"boost_mode","expireDate":"20230420:165753"},"lastDefaultMode":"max_mode"}}
    ${ID}    QueryDataReturnID    ${DataBaseNameNSB}    ${CollactionNameLivingNetworkMSISDN}    ${msisdn}
    DelectDataFromID    ${DataBaseNameNSB}    ${CollactionNameLivingNetworkMSISDN}    ${ID}
...
TST_F13_1_1_076
    ...
    #check db
    ${currentDate}    CurrentDate
    VerifyMongoDB    ${Jsondata}    {"msisdn":"66812344012","package":{"currentPackage":"O2103P210305313","productSequenceId":"0002480109997","freeUnitExpireTime":"20240401000000+0800"},"5GMode":{"changeModePerday":{"count":1,"currentDate":"${currentDate}"},"currentMode":{"modeName":"boost_mode","expireDate":"20230420:171105"},"lastDefaultMode":"max_mode"}}
    ${ID}    QueryDataReturnID    ${DataBaseNameNSB}    ${CollactionNameLivingNetworkMSISDN}    ${msisdn}
    DelectDataFromID    ${DataBaseNameNSB}    ${CollactionNameLivingNetworkMSISDN}    ${ID}
...
TST_F13_1_1_079
    ...
    #check db
    ${currentDate}    CurrentDate
    VerifyMongoDB    ${Jsondata}    {"msisdn":"66812344016","package":{"currentPackage":"O2103P210305313","productSequenceId":"0002480109997","freeUnitExpireTime":"20240401000000+0800"},"5GMode":{"changeModePerday":{"count":1,"currentDate":"${currentDate}"},"currentMode":{"modeName":"boost_mode","expireDate":"20230420:174710"},"lastDefaultMode":"max_mode"}}
    ${ID}    QueryDataReturnID    ${DataBaseNameNSB}    ${CollactionNameLivingNetworkMSISDN}    ${msisdn}
    DelectDataFromID    ${DataBaseNameNSB}    ${CollactionNameLivingNetworkMSISDN}    ${ID}
...
TST_F13_1_1_080
    ...
    #check db
    ${currentDate}    CurrentDate
    VerifyMongoDB    ${Jsondata}    {"msisdn":"66812344017","package":{"currentPackage":"O2103P210305313","productSequenceId":"0002480109997","freeUnitExpireTime":"20240401000000+0800"},"5GMode":{"changeModePerday":{"count":1,"currentDate":"${currentDate}"},"currentMode":{"modeName":"boost_mode","expireDate":"20230420:175756"},"lastDefaultMode":"max_mode"}}
    ${ID}    QueryDataReturnID    ${DataBaseNameNSB}    ${CollactionNameLivingNetworkMSISDN}    ${msisdn}
    DelectDataFromID    ${DataBaseNameNSB}    ${CollactionNameLivingNetworkMSISDN}    ${ID}
...
TST_F13_1_1_081
    ...
    #check db
    ${currentDate}    CurrentDate
    VerifyMongoDB    ${Jsondata}    {"msisdn":"66812344018","package":{"currentPackage":"O2103P210305313","productSequenceId":"0002480109997","freeUnitExpireTime":"20240401000000+0800"},"5GMode":{"changeModePerday":{"count":1,"currentDate":"${currentDate}"},"currentMode":{"modeName":"boost_mode","expireDate":"20230420:180519"},"lastDefaultMode":"max_mode"}}
    ${ID}    QueryDataReturnID    ${DataBaseNameNSB}    ${CollactionNameLivingNetworkMSISDN}    ${msisdn}
    DelectDataFromID    ${DataBaseNameNSB}    ${CollactionNameLivingNetworkMSISDN}    ${ID}
...
TST_F13_1_1_082
    ...
    #check db
    ${currentDate}    CurrentDate
    VerifyMongoDB    ${Jsondata}    {"msisdn":"66812344019","package":{"currentPackage":"O2103P210305313","productSequenceId":"0002480109997","freeUnitExpireTime":"20240401000000+0800"},"5GMode":{"changeModePerday":{"count":1,"currentDate":"${currentDate}"},"currentMode":{"modeName":"boost_mode","expireDate":"20230420:181319"},"lastDefaultMode":"max_mode"}}
    ${ID}    QueryDataReturnID    ${DataBaseNameNSB}    ${CollactionNameLivingNetworkMSISDN}    ${msisdn}
    DelectDataFromID    ${DataBaseNameNSB}    ${CollactionNameLivingNetworkMSISDN}    ${ID}
...
TST_F13_1_1_105
    ...
    #check db
    ${currentDate}    CurrentDate
    VerifyMongoDB    ${Jsondata}    {"msisdn":"66812340055","package":{"currentPackage":"O2103P210305313","productSequenceId":"0002480109997","freeUnitExpireTime":"20230430235959+0700"},"5GMode":{"changeModePerday":{"count":1,"currentDate":"${currentDate}"},"currentMode":{"modeName":"game_mode","expireDate":"20230419:191052"},"lastDefaultMode":"max_mode"}}
    ${ID}    QueryDataReturnID    ${DataBaseNameNSB}    ${CollactionNameLivingNetworkMSISDN}    ${msisdn}
    DelectDataFromID    ${DataBaseNameNSB}    ${CollactionNameLivingNetworkMSISDN}    ${ID}
...
TST_F13_1_1_106
    ...
    #check db
    ${currentDate}    CurrentDate
    VerifyMongoDB    ${Jsondata}    {"msisdn":"66812340056","package":{"currentPackage":"O2103P210305313","productSequenceId":"0002480109997","freeUnitExpireTime":"20230430235959+0700"},"5GMode":{"changeModePerday":{"count":2,"currentDate":"${currentDate}"},"currentMode":{"modeName":"game_mode","expireDate":"20230419:191954"},"lastDefaultMode":"max_mode"}}
    ${ID}    QueryDataReturnID    ${DataBaseNameNSB}    ${CollactionNameLivingNetworkMSISDN}    ${msisdn}
    DelectDataFromID    ${DataBaseNameNSB}    ${CollactionNameLivingNetworkMSISDN}    ${ID}
...
TST_F13_1_1_107
    ...
    #check db
    ${currentDate}    CurrentDate
    VerifyMongoDB    ${Jsondata}    {"msisdn":"66812340057","package":{"currentPackage":"O2103P210305313","productSequenceId":"0002480109997","freeUnitExpireTime":"20230430235959+0700"},"5GMode":{"changeModePerday":{"count":1,"currentDate":"${currentDate}"},"currentMode":{"modeName":"boost_mode","expireDate":"20230419:202800"},"lastDefaultMode":"max_mode"}}
    ${ID}    QueryDataReturnID    ${DataBaseNameNSB}    ${CollactionNameLivingNetworkMSISDN}    ${msisdn}
    DelectDataFromID    ${DataBaseNameNSB}    ${CollactionNameLivingNetworkMSISDN}    ${ID}
...
TST_F13_1_1_108
    ...
    #check db
    ${currentDate}    CurrentDate
    VerifyMongoDB    ${Jsondata}    {"msisdn":"66812340058","package":{"currentPackage":"O2103P210305313","productSequenceId":"0002480109997","freeUnitExpireTime":"20230430235959+0700"},"5GMode":{"changeModePerday":{"count":6,"currentDate":"${currentDate}"},"currentMode":{"modeName":"boost_mode","expireDate":"20230419:203735"},"lastDefaultMode":"max_mode"}}
    ${ID}    QueryDataReturnID    ${DataBaseNameNSB}    ${CollactionNameLivingNetworkMSISDN}    ${msisdn}
    DelectDataFromID    ${DataBaseNameNSB}    ${CollactionNameLivingNetworkMSISDN}    ${ID}
